---
title: "Predicting tornado count distributions by EF rating"
author: "James Elsner"
date: "2/14/2019"
...
We need to join the environmental variables at the outbreak-level to the tornado level.
```{r}
...
Consider how the model handles bulk shear. Set all variables to zero except distance to city and bulk shear. The scale and center parameters of the bulk shear variable are obtained and then extremes values are used.
```{r}
BSs <- scale(df2$maxBS)
