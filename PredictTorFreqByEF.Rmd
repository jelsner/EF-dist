...
Estimating tornado counts by EF rating on days with many tornadoes
...
( p <- ggplot(ggYr, aes(x = Yr, y = estimate__, col = cats__)) +
  ...
  geom_ribbon(aes(ymin = lower__, ymax = upper__, fill = cats__), 
              alpha = .7, col = NA) +
  scale_color_brewer(name = "EF", label = c("0", "1", "2", "3", "4", "5"), palette = "Reds") +
  scale_fill_brewer(name = "EF", label = c("0", "1", "2", "3", "4", "5"), palette = "Reds") +
  scale_y_continuous(limits = c(0, 1)) +
