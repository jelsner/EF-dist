...
post.df <- posterior_samples(m1.3)
```
...
Marginal plots.
```{r}
gg <- marginal_effects(m1.3, categorical = TRUE)
ggBS <- gg[[5]]

ggplot(ggBS, aes(x = BSs, y = estimate__, col = cats__)) +
  geom_line() 
```
